...
const _AllFormats: import('../sim/dex-formats').FormatList = [

	// RC Singles (Custom Format)
	{
		section: "RC Singles",
	},
	{
		name: "[Gen 9] NatDex RC OU",
		mod: 'gen9',
	...
	{
		name: "[Gen 9] NatDex RC OU Blitz",
		mod: 'gen9',
		ruleset: ['Standard Natdex','Terastal Clause', 'Blitz'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
			'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail', 'Buzzy Buzz', 'Sizzly Slide',
			'Revival Blessing', 'Greninja + Nasty Plot', 'Glaciate', 'UNOB'
	...
	{
		name: "[Gen 9] NatDex RC AG",
		mod: 'gen9',
		ruleset: ['Standard AG', 'NatDex Mod', 'Terastal Clause'],
		banlist: ['UNOB'],
	},

	// RC Doubles (Custom Format)
	{
		section: "RC Doubles",
	},
	{
		name: "[Gen 9] NatDex RC Doubles OU",
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Gravity Sleep Clause'],
		banlist: [
			'Arceus', 'Calyrex-Ice', 'Calyrex-Shadow', 'Deoxys-Attack', 'Dialga', 'Eternatus',
			'Genesect', 'Giratina', 'Groudon', 'Hoopa-Unbound', 'Ho-Oh',
			'Koraidon', 'Kyogre', 'Kyurem-Black', 'Kyurem-White', 'Lugia', 'Lunala',
			'Magearna', 'Melmetal', 'Mewtwo', 'Miraidon', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane',
			'Palkia', 'Rayquaza', 'Reshiram', 'Solgaleo', 'Terapagos',
			'Urshifu', 'Urshifu-Rapid-Strike', 'Xerneas', 'Yveltal',
	...
	{
		name: "[Gen 9] NatDex RC VGC 2026 Ruleset A",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
	...
	{
		name: "[Gen 9] NatDex RC VGC 2026 Ruleset B",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Flat Rules', 'Standard NatDex', '! Sleep Clause Mod', 'Terastal Clause', '!! Adjust Level = 50', 'VGC Timer', 'Force Open Team Sheets', '! OHKO Clause', '! Evasion Clause'],
	...
	{
		name: "[Gen 9] NatDex RC VGC 2026 Ruleset C",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
	...
	},
	{
		...
		banlist: ['UNOB'],
         ...
         //Expanded RC Formats
	{
		section: "Expanded RC Formats",
	},
	{
		name: "[Gen 9] NatDex EX. RC OU",
		mod: 'gen9',
		ruleset: ['Standard Natdex','Terastal Clause'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
	...
	{
		name: "[Gen 9] NatDex EX. RC OU Blitz",
		mod: 'gen9',
		ruleset: ['Standard Natdex','Terastal Clause', 'Blitz'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
	...
	{
		name: "[Gen 9] NatDex EX. RC UU Blitz",
		mod: 'gen9',
		ruleset: ['[Gen 9] National Dex', 'Blitz'],
		banlist: ['ND OU', 'ND UUBL', 'Drizzle', 'Drought', 'Light Clay', 'Buzzy Buzz', 'Sizzly Slide',
			'Revival Blessing',
	...
	{
		name: "[Gen 9] NatDex EX. RC AG",
		mod: 'gen9',
		ruleset: ['Standard AG', 'NatDex Mod', 'Terastal Clause'],
	},
	{
		name: "[Gen 9] NatDex EX. RC Doubles OU",
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Gravity Sleep Clause'],
		banlist: [
	...
	{
		name: "[Gen 9] NatDex EX. RC VGC 2026 Ruleset A",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Flat Rules', 'Standard NatDex', '! Sleep Clause Mod', 'Terastal Clause', '!! Adjust Level = 50', 'VGC Timer', 'Force Open Team Sheets', '! OHKO Clause', '! Evasion Clause'],
		banlist: ['Sub-Legendary', 'Paradox', 'Mythical'],
	},
	{
		name: "[Gen 9] NatDex EX. RC VGC 2026 Ruleset B",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Flat Rules', 'Standard NatDex', '! Sleep Clause Mod', 'Terastal Clause', '!! Adjust Level = 50', 'VGC Timer', 'Force Open Team Sheets', '! OHKO Clause', '! Evasion Clause'],
	...
	{
		name: "[Gen 9] NatDex EX. RC VGC 2026 Ruleset C",
		mod: 'gen9',
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Flat Rules', 'Standard NatDex', '! Sleep Clause Mod', 'Terastal Clause', '!! Adjust Level = 50', 'VGC Timer', 'Force Open Team Sheets', '! OHKO Clause', '! Evasion Clause', 'Limit Two Restricted'],
...
// Hide all non-RC formats from search, challenges, and teambuilder
let _rcBoundaryIdx = _AllFormats.length;
let _passedFirstSection = false;
for (let _i = 0; _i < _AllFormats.length; _i++) {
	const _f = _AllFormats[_i];
	if ('section' in _f) {
		if (_passedFirstSection && !(_f.section as string).startsWith('RC')) {
			_rcBoundaryIdx = _i;
			break;
		}
		_passedFirstSection = true;
	}
}
export const Formats = _AllFormats;
