...
Storage.bg = {
	...
	load: function (bgUrl, bgid, hues) {
		this.id = bgid;
		if (!bgid || bgid === 'waterfall' || bgid === 'horizon' || bgid === 'ocean' || bgid === 'shaymin' || bgid === 'charizards' || bgid === 'psday') {
			bgid = 'main_game_logo';
			bgUrl = 'fx/client-bg-main_game_logo.png';
		}
