		...
		return <PSPanelWrapper room={room} scrollable><div class="pad">
			...
			<div class="roomlist">
				<p>
					...
					<span
						style={Dex.getPokemonIcon('typhlosion-hisui') + ';display:inline-block;vertical-align:middle'} class="picon"
						title="Typhlosion is Roria Showdowns Mascot! Why? .. we just like it."
					></span>
				</p>
