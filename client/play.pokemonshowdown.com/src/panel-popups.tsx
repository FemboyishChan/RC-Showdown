			...
			<form onSubmit={this.handleRegisterUser}>
				...
				<p>
					<label class="label"><img
						src="https://play.pokemonshowdown.com/sprites/gen5ani/avalugg.gif"
						alt="A large Ice-type Pokémon covered in a thick sheet of ice."
					/></label>
				</p>
				<p>
					<label class="label">
...
class BackgroundListPanel extends PSRoomPanel {
	...
	override render() {
		...
		return this.renderUpload() || <PSPanelWrapper room={room} width={480}><div class="pad">
			...
			<div class="bglist">
				<button onClick={this.setBg} value="main_game_logo" class={option('main_game_logo')}>
					<img src="fx/client-bg-main_game_logo.png" style="width:80px;height:80px;object-fit:cover;display:block" />{}
					Default
				</button>
			</div>
			<div style="clear: left"></div>
